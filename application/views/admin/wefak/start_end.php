        ...
        <fieldset>
            ...
            <div class="form-group"  >
                ...
                <div class="col-lg-4 input-grup">
                    ...
                    <input type="date" id="popupDatepicker" value="<?php echo date("Y-m-d",$result[0]->start_date) ?>" name="start_date" class="form-control text-right"  required="required"/>
                </div>
                <label for="inputUser" class="col-lg-2 control-label"> تاريخ النهاية:</label>
                <div class="col-lg-4 input-grup">
                
                
                    <input type="date" id="popupDatepicker2" value="<?php echo date("Y-m-d", $result[0]->end_date); ?>" name="end_date" class="form-control text-right"  required="required"/>
                </div>
            </div>
        ...
        <fieldset>
            ...
            <div class="form-group"  >
                ...
                <div class="col-lg-10 input-grup">
                    ...
                    if($course){
                        echo " <option value=''>قم بإختيار الكورس</option>";
                        foreach($course as $cources){
                            echo '<option value="'.$cources->sessions_id_pk.'">'.$cources->sessions_name.'</option>';}
                    }else{
                      echo " <option value=''>يجب إضافة متدربين للكورس قبل إضافة المواعيد</option>"; 
                    }
            ...
            <div class="form-group"  >
                ...
                <div class="col-lg-10 input-grup">
                    ...
                    <select id="trainer_id"  name="trainer_id"  class="form-control text-right" required="required" >
                    <option value="">قم بإختيار المدرب</option>
            ...
            <div class="form-group"  >
                ...
                <div class="col-lg-4 input-grup">
                    ...
                    <input type="date" id="popupDatepicker"  name="start_date" class="form-control text-right"  required="required" />
                </div>
                <label for="inputUser" class="col-lg-2 control-label"> تاريخ النهاية:</label>
                <div class="col-lg-4 input-grup">
                
                
                    <input type="date" id="popupDatepicker2"  name="end_date" class="form-control text-right"  required="required" />
                </div>
            </div>
