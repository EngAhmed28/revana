...
<h4 class="text-center">أحدث الأخبار معهد ريفانا</h4>
                <div class="col-sm-8 padding-3">
                  
                    <ul class="nav nav-pills">
                        <li class="col-sm-3 padding-3"><a href="#tab-1" data-toggle="tab"><img src="img/slider/resizeimagehandler (1).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-2" data-toggle="tab"><img src="img/slider/resizeimagehandler (2).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-3" data-toggle="tab"><img src="img/slider/resizeimagehandler (3).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-4" data-toggle="tab"><img src="img/slider/resizeimagehandler (4).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-5" data-toggle="tab"><img src="img/slider/resizeimagehandler (5).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-6" data-toggle="tab"><img src="img/slider/resizeimagehandler (6).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-7" data-toggle="tab"><img src="img/slider/resizeimagehandler (7).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-8" data-toggle="tab"><img src="img/slider/resizeimagehandler (8).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-9" data-toggle="tab"><img src="img/slider/resizeimagehandler (9).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-10" data-toggle="tab"><img src="img/slider/resizeimagehandler (10).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-11" data-toggle="tab"><img src="img/slider/resizeimagehandler (11).jpg"></a></li>
                        <li class="col-sm-3 padding-3 active"><a href="#tab-12" data-toggle="tab"><img src="img/slider/resizeimagehandler (12).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-13" data-toggle="tab"><img src="img/slider/resizeimagehandler (13).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-14" data-toggle="tab"><img src="img/slider/resizeimagehandler (14).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-15" data-toggle="tab"><img src="img/slider/resizeimagehandler (15).jpg"></a></li>
                        <li class="col-sm-3 padding-3"><a href="#tab-16" data-toggle="tab"><img src="img/slider/resizeimagehandler (1).jpg"></a></li>
                    </ul>
                </div>
                <div class="col-sm-4 padding-3">
                    ...
                    <div class="tab-content well">
                        <div class="tab-pane" id="tab-1">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (1).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-2">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (2).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">"إيلاف" ترصد التطورات العسكرية في جبهات القتال اليمنية </a></h4>
                                <p class="paragraph">أعلن باحثون في امن الكمبيوتر الاثنين انهم اكتشفوا صلة محتملة لكوريا الشمالية بالهجوم الالكتروني العالمي، الذي يستهدف منذ الجمعة عشرات آلاف .</p>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-3">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (3).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-4">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (4).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-5">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (5).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-6">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (6).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-7">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (7).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-8">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (8).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-9">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (9).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-10">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (10).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-11">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (11).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
                        ...
                        <div class="tab-pane active" id="tab-12">
                            <div class="post">
                                <img src="img/slider/resizeimagehandler (12).jpg">
                                <p class="text-left top-p">تحذيرات من عمليات قرصنة جديدة</p>
                                <h4> <a href="#">قمة بين ترمب وأردوغان في واشنطن </a></h4>
                                <p class="paragraph">وصل الرئيس التركي رجب طيب أردوغان إلى واشنطن في زيارة رسمية للولايات المتحدة يلتقي خلالها نظيره الأميركي دونالد ترمب، ويبحث معه سلسلة قضايا شائكة.</p>
                            </div>
...
<section class="col-xs-12 visible-xs">
    ...
    <section class="home col-xs-12" >
        <div id="divider" class="divider">
            <p>
                ...
                انضم إلى أكثر من <strong>مليون</strong> متعلّم حول العالم مع ريفانا
            </p>
        </div>
    </section>

    <section class="col-xs-12 text-center about-index no-padding">
        <div class="parlex3-back">
            <div class="container">
                <div class="col-sm-8">
                    <h2> مؤسسة  ريفانا التدريبية  </h2>
                    <? if(!empty($about_us)):?>
                    <p><? echo
                ...
                <div class="col-sm-4">
                    <img src="<?php echo base_url() ?>asisst/web_asset/img/courses-icon-6.png" width="100%">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="col-xs-12 r-center-vedio">
        <div class="col-sm-9 r-center-one">
            <h6 class="text-center"> دورات مؤسسة ريفانا </h6>
...
<div class="col-xs-12 r-courses">
    <div class="col-xs-12">
        <h4 id="heading"> أحدث الكورسات   </h4>
    </div>
    <div id="owl-demo11" class="owl-carousel owl-theme">
        <? if(!empty($home_courses)):
        foreach ($home_courses as $record):
...
<section class="gallery" id="thumbnails">
    <div class="container">
        <div class="col-xs-12">
            <h4 id="heading">مكتبة صور معهد ريفانا</h4>
        </div>
        <br>
...
<section class="features text-center">
    <div class="container">
        <div class="col-xs-12">
            <h4 class="text-center">اهم ما تقدمه ريفانا</h4>
        </div>
...
<section class="says text-center">
    <div class="container">
        <h4 class="title">أراء المتدربين لدى معهد ريفانا</h4>
        <div id="owl-demo2" class="owl-carousel owl-theme">
            ...
            <div class="item text-center">
                ...
                <h6><i class="fa fa-quote-left" aria-hidden="true"></i><?php echo $record->trainer_id?><i class="fa fa-quote-right" aria-hidden="true"></i></h6>
                <p>
                 <? echo $record->trainer_openion;?> </p>
             </div>
         <?  endforeach; endif;?>
     </div>
 </div>
