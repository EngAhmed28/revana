...
<?php if(isset($result)):?>
    ...
    <?php echo form_open_multipart('dashboard/updatebenefits/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
...
<?php else: ?>
    ...
    <?php echo form_open_multipart('dashboard/addbenefits',array('class'=>"form-horizontal",'role'=>"form" ))?>
    <fieldset>
        ...
        <div class="col-xs-10 col-xs-pull-2">
            ...
            <input type="submit"  name="add_benefits" value="حفظ" class="btn btn-primary" >
        </div>
        ...
        <?php foreach($records as $record):?>
            ...
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a href="<?php echo base_url().'dashboard/updatebenefits/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>

                    <a  href="<?php echo base_url().'dashboard/deletebenefits/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-5"><i class="fa fa-trash"></i> حذف</a>

                </td>

                <td data-title="حالة المقطع" class="text-center">

                    <a href="<?php echo base_url().'dashboard/suspendbenefits/'.$record->id.'/'.$class?>" class="btn btn-<?php echo $class ?> btn-xs col-lg-5"><?php echo $title ?> </a>
