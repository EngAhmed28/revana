            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <select id="sessions_id_fk" name="sessions_id_fk" class="selectpicker form-control" data-live-search="true" style="width:100%;">
                        <option  value="<?echo $result['sessions_id_fk'] ?>"><?php echo $result['sessions_id_fk'] ?></option>
                        ...
                        if($session->sessions_id_pk == $result['sessions_id_fk'])
                            $select = 'selected';
                        ?>
                            <option value="<?echo $session->sessions_id_pk?> " <?php echo $select ?>><?php echo $session->sessions_name?>  </option>
                        <?php endforeach?>
                    </select>
                </div>
            </div>
                ...
                <div class="col-lg-10">
                    <select id="sessions_id_fk" name="sessions_id_fk" class="selectpicker form-control" data-live-search="true" style="width:100%;">
                        ...
                        <?php foreach($sessions as $session):?>
                            ...
                            <option style="text-align: right;" value="<?echo $session->sessions_id_pk?> "><?php  echo $session->sessions_name?>  </option>
                        <?php endforeach?>
                    </select>
                </div>
            </div>
    ...
    <table id="no-more-tables" class="table table-bordered" role="table">
        ...
        foreach($records as $record):?>
            <tr>
                ...
                <td data-title=""> <p class="text-center"><?php if($record->sessions_reserve_notes) echo $record->sessions_reserve_notes; else echo 'لا يوجد';?></p> </td>
