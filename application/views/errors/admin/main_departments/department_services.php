...
<div class="well bs-component" >
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('dashboard/updateservice/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        <fieldset>
                ...
                <div class="col-lg-10">
                    <select id="depart_id" name="depart_id" class="form-control">
                        ...
                        <?foreach($fields as $field):?>
                            <?php $selected=''; if($result['field_id']==$field->id):$selected='selected';?>
                            <?php endif;?>
            ...
            <div class="form-group"  >
                ...
                <label for="inputUser" class="col-lg-2 control-label">إسم الخدمة:</label>
                ...
                <div class="col-lg-10 input-grup">
                    ...
                    <input type="text" id="title"  value="<?php echo $result['title']; ?>" name="title" class="form-control text-right" placeholder="إسم الخدمة">
            ...
            <div class="form-group"  >
                ...
                <label for="inputUser" class="col-lg-2 control-label">صورة الخدمة:</label>
    ...
    <?php else: ?>
        ...
        <?php echo form_open_multipart('dashboard/addservice',array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        <fieldset>
            ...
            <div class="form-group"  >
                ...
                <div class="col-lg-10 input-grup">
                    ...
                    <input type="text" id="title"  name="title" class="form-control text-right" placeholder="إسم الخدمة" required>
            ...
            <div class="form-group" >
                ...
                <div class="col-xs-10 col-xs-pull-2">
                    ...
                    <input type="submit"  name="add_service" value="حفظ" class="btn btn-primary" >
...
<?php if(isset($records)&&$records!=null):?>
    ...
    <table id="no-more-tables" class="table table-bordered" role="table">
        ...
        <tr>
            ...
            <th  class="text-right">إسم الخدمة</th>
        ...
        <?php foreach($records as $record):
            ...
            <tr>
                ...
                <td data-title="إسم الخدمة"><?php echo $record->title?> </td>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a  href="<?php echo base_url().'dashboard/deleteservice/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-5"><i class="fa fa-trash"></i> حذف</a>



                    <a href="<?php echo base_url().'dashboard/updateservice/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>
            ...
            <div class="modal fade" id="myModal<?php echo $record->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <br />
                        <div class="col-sm-3">إسم الخدمة</div>
                        <div class="col-sm-9"><?php echo $record->title?></div>
                        <br />
                        <div class="modal-body">
                            <div class="col-md-3"> صورة الخدمة </div>
