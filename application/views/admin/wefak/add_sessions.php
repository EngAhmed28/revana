            ...
            <div class="form-group"  >
                ...
                <div class="col-lg-10">
                    <select id="course_id_fk" name="course_id_fk" class="form-control">
                        ...
                        $select='';
                        if($result['course_id_fk'] == $Course->course_id_pk){ $select='selected';}?>
                            <option value="<?php echo $Course->course_id_pk?>" <?php echo $select; ?> ><?php echo $Course->course_name?>  </option>
                        <?php endforeach?>
                    </select>
                </div>
            </div>
        ...
        <fieldset>
            ...
            <div class="form-group"  >
                ...
                <div class="col-lg-10">
                    ...
                    <select id="course_id_fk" name="course_id_fk" class="form-control">
                        <?php foreach($Courses as $Course):?>
                            <option value="<?php echo $Course->course_id_pk?> "><?php echo $Course->course_name?>  </option>
                        <?php endforeach?>
                    </select>
                </div>
            </div>
