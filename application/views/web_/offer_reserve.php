   ...
   echo form_open_multipart('Reserve/offer_reserve/'.$num,array('class'=>"form-horizontal",'role'=>"form" ))?>
...
?>
    ...
    <div class="trainer-details col-xs-12">
        ...
        <table class="table table-striped table-bordered">
            <tr>
                <td>اسم المتدرب</td>
                <td><input type="text" name="offers_reserve_name" class="form-control"></td>
                <td>رقم الهوية</td>
            ...
            <tr>
                ...
                <td>المؤهل</td>
                <td><input type="text" name="offers_reserve_qualification" class="form-control"></td>
            </tr>

            <tr>
                <td>مكان / تاريخٌ الميلٌاد</td>
                <td><input type="text" name="offers_reserve_barth_place" class="form-control"></td>
                <td>رقم الهاتف</td>
                <td><input type="text" name="offers_reserve_phone" class="form-control"></td>
            </tr>
...
<center>
   <input type="submit"  name="add_offers_reserve" value="حفظ طلب الحجز" class="btn btn-primary" >
</center>
</div>
<!--
    <div class="eqrar col-xs-12">
