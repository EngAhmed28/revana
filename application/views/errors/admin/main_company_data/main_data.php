        ...
        <span class="progress-active"></span>
                      ...
                      <thead>';
                          ...
                          '.$td.'
                                ...
                                <div class="form-div">
                                    <label>رقم الهاتف :</label>
                                    <input type="number" id="address_info"  name="address_info" min="1" max="5" onkeyup="return lood($('#adderss_info').val(),'#optionearea2','address_info');" class="form-control text-right" placeholder="   أقصى عدد 5" >
                                </div>
                                ...
                                $address=unserialize($result['address_info']);
                                if($address){
                                    echo '<table class="table table-bordered table-hover table-striped" cellspacing="0" " style="margin-right: 191px; width: 56%;" >
                      <thead>';
                                    for($x = 0 ; $x < count($address) ; $x++){
                                        ...
                                        {
                                            $td = '<td style="padding-top: 10%px;">
                               <a  href="'.base_url().'dashboard/delete/address_info/'.$result['id'].'/'.$x.'"  class="btn btn-danger btn-xs col-lg-12">
                                حذف <i class="fa fa-trash"></i></a>
                               </td>';
                                        }
                                        else
                                        ...
                                        echo '<tr class="">
                          <td>
                          <input type="text" name="address_old'.$x.'" class="form-control" style="width: 500px;" value="'.$address[$x].'" title="يجب أدخال عنوان"/>
                          </td>
                          '.$td.'
                          </tr>';
                                    }
                      ...
                      <thead>';
                          ...
                          '.$td.'
                                        ...
                                        ?>
                                        <input type="hidden" name="count_address" value="<?php echo count($address) ?>" />
                    ...
                    <div class="tabs-content">
                        ...
                        <div id="customer" class="jq-tab-box clearfix" style="display: block;">
                            <div class="col-xs-12">
                                ...
                                <div class="form-div">
                                    <label>عنوان الشركة :</label>
                                    <input type="number" id="address_info"  name="address_info" min="1" max="5" onkeyup="return lood($('#address_info').val(),'#optionearea2','address_info');" class="form-control text-right" placeholder="   أقصى عدد 5" required>
                                </div>
                                <div id="optionearea2"></div>
