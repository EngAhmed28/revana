...
<div class="well bs-component" >
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('dashboard/updatelogan/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
    ...
    <?php else: ?>
        ...
        <?php echo form_open_multipart('dashboard/addlogan',array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        <fieldset>
            ...
            <div class="form-group" >
                ...
                <div class="col-xs-10 col-xs-pull-2">
                    ...
                    <input type="submit"  name="add_logan" value="حفظ" class="btn btn-primary" >
        ...
        <?php foreach($records as $record):
            ...
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a  href="<?php echo base_url().'dashboard/deletelogan/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-5"><i class="fa fa-trash"></i> حذف</a>



                    <a href="<?php echo base_url().'dashboard/updatelogan/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>
