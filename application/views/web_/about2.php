    ...
    <div class="container">
        <div class="col-xs-12">
            ...
            <ul class="nav nav-tabs text-center" role="tablist">
                ...
                <li role="presentation">
                    <a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"> <span> <i class="fa fa-envelope-square" aria-hidden="true"></i></span> الرسالة</a>
                </li>
                <li role="presentation">
                    <a href="#settings" aria-controls="settings" role="tab" data-toggle="tab"> <span> <i class="fa fa-eye" aria-hidden="true"></i>
                        </span> رؤيتنا </a>
                </li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="home">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <p><?php echo strip_tags($record->content) ?></p>
                    </div>
                    <?php endforeach; ?>
                    <?php endif; ?>
                    <div class="col-sm-4 hidden-xs">
                        <img src="<?php echo base_url() ?>asisst/web_asset/img/IMG-20170422-WA0001.jpg" alt="" class="center-block">
                    </div>
                </div>
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <ul class="r-course-help">
                            ...
                            <li> <span> <i class="fa fa-angle-double-left" aria-hidden="true"></i>
                                     </span><?php echo strip_tags($record->content) ?>
                            </li>
                           <?php endforeach; ?>
                            <?php endif; ?>
                        </ul>
        ...
        <div class="col-xs-12 r-sevices-center">
            <?php if(isset($benifits)&& $benifits!=null):?>

            <?php foreach ($benifits as $record): ?>
            <div class="col-sm-4 text-center">
                <div class="r-serv">
                    <i class="<?php  echo'<img src="'. base_url('uploads/images').'/'. $record->img.'" alt="...">' ?>" aria-hidden="true"></i>
                    <h4><?php echo $record->title ?> </h4>
                    <p class="text-center"><?php echo strip_tags($record->content) ?> </p>
                </div>
            </div>
           <?php endforeach; ?>
            <?php endif; ?>
