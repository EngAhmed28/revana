...
<div class="well bs-component" >
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('dashboard/update_comp_political/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        <fieldset>
            ...
            <div class="form-group"  >
                <label for="inputUser" class="col-lg-2 control-label">إسم المقطع:</label>
                <div class="col-lg-10 input-grup">
                    <i class="fa fa-newspaper-o"></i>
                    <input type="text" id="title" value="<?php echo $result['title'] ?>"  name="title" class="form-control text-right" placeholder="إسم المقطع">
                </div>
            </div>
    ...
    <?php else: ?>
        ...
        <?php echo form_open_multipart('dashboard/add_comp_political',array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        <fieldset>
            ...
            <div class="form-group"  >
                ...
                <div class="col-lg-10 input-grup">
                    <i class="fa fa-newspaper-o"></i>
                    <input type="text" id="title"   name="title" class="form-control text-right" placeholder="إسم المقطع">
                </div>
            </div>
            ...
            <div class="form-group" >
                <div class="col-xs-10 col-xs-pull-2">
                    ...
                    <input type="submit"  name="add_comp_political" value="حفظ" class="btn btn-primary" >
                </div>
            </div>
...
<?php if(isset($records)&&$records!=null):?>
    ...
    <table id="no-more-tables" class="table table-bordered" role="table">
        ...
        <tr>
            ...
            <th  class="text-right">إسم المقطع</th>
        ...
        <tr>
            ...
            <td data-title="إسم الشعار"><?php echo $record->title?> </td>
            ...
            <td data-title="التحكم" class="text-center">
                ...
                <a  href="<?php echo base_url().'dashboard/delete_comp_political/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-5"><i class="fa fa-trash"></i> حذف</a>



                <a href="<?php echo base_url().'dashboard/update_comp_political/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>
