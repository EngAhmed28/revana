...
<?php if(isset($result)):?>
    ...
    <?php echo form_open_multipart('dashboard/update_vision/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
...
<?php elseif(! $records): ?>
    ...
    <?php echo form_open_multipart('dashboard/add_vision',array('class'=>"form-horizontal",'role'=>"form" ))?>
    <fieldset>
        ...
        <div class="col-xs-10 col-xs-pull-2">
            ...
            <input type="submit"  name="add_vision" value="حفظ" class="btn btn-primary" >
        </div>
            ...
            <?php foreach($records as $record):?>
                ...
                <tr>
                    ...
                    <td data-title="التحكم" class="text-center">
                        ...
                        <a href="<?php echo base_url().'dashboard/update_vision/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>

                        <a  href="<?php echo base_url().'dashboard/delete_vision/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-5"><i class="fa fa-trash"></i> حذف</a>

                    </td>

                    <td data-title="حالة المقطع" class="text-center">

                        <a href="<?php echo base_url().'dashboard/suspend_vision/'.$record->id.'/'.$class?>" class="btn btn-<?php echo $class ?> btn-xs col-lg-5"><?php echo $title ?> </a>
