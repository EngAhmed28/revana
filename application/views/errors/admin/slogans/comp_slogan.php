...
<div class="well bs-component" >
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('dashboard/updateslogan/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        <fieldset>
            ...
            <div class="form-group"  >
                ...
                <label for="inputUser" class="col-lg-2 control-label">إسم الشعار:</label>
                ...
                <div class="col-lg-10 input-grup">
                    ...
                    <input type="text" id="title"  value="<?php echo $result['title']; ?>" name="title" class="form-control text-right" placeholder="إسم الشعار">
    ...
    <?php else: ?>
        ...
        <?php echo form_open_multipart('dashboard/addslogan',array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        <fieldset>
            ...
            <div class="form-group"  >
                ...
                <div class="col-lg-10 input-grup">
                    ...
                    <input type="text" id="title"  name="title" class="form-control text-right" placeholder="إسم الشعار" required>
            ...
            <div class="form-group" >
                ...
                <div class="col-xs-10 col-xs-pull-2">
                    ...
                    <input type="submit"  name="add_slogan" value="حفظ" class="btn btn-primary" >
        ...
        <?php foreach($records as $record):
            ...
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a  href="<?php echo base_url().'dashboard/deleteslogan/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-5"><i class="fa fa-trash"></i> حذف</a>



                    <a href="<?php echo base_url().'dashboard/updateslogan/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>
            ...
            <div class="modal fade" id="myModal<?php echo $record->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <br />
                        <div class="col-sm-3">إسم الشعار</div>
                        <div class="col-sm-9"><?php echo $record->title?></div>
                        <br />
                        <div class="modal-body">
                            <div class="col-md-3"> صورة الشعار </div>
