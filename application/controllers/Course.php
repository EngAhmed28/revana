...
class Course extends CI_Controller
{
    ...
    public function single_course($id){
       ...
       //$this->test($data['course_data'] );
 /*
        $data['offer_data'] = $this->Offers->select_by_web($id);
        $data['offer_details'] = $this->Offers->select_details_web();
        $data['offer_features'] = $this->Offers->select_details_special_web();
        $data['offer_other'] = $this->Offers-> select_other_offers($data['offer_data'][0]->id);*/
