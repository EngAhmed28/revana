...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://s.bookcdn.com/css/w/booked-wzs-widget-275.css?v=0.0.1">
...
<li><a href="https://webmail1.hostinger.ae/roundcube/?_task=logout&_token=1jmhxGbu5MvNb2nq27Q5qBQloiHSG6af">دخول الإيميل الإلكتروني</a></li>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="<?php echo base_url().'about'?>">عن معهد ريفانا</a></li>
				<li class="dropdown">
			...
			<li><a href="<?php echo base_url().'offers'?>" class="offer "><i class="fa fa-bullhorn faa-ring animated" aria-hidden="true"></i> عروضنا</a></li>

			<li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">بث مباشر للدورات <span class="caret"></span></a>
				<ul class="dropdown-menu">
					<?if(!empty($this->all_courses_drop)):
					foreach ($this->all_courses_drop as $record):?>
		...
		<li><a href="<?php echo base_url().'contact_web'?>">اتصل بنا</a></li>
        	<li><a href="<?php echo base_url().'room'?>">غرف الإجتماعات</a></li>
	</ul>
</div><!-- /.navbar-collapse -->
</div><!-- /.container-fluid -->
</nav>
