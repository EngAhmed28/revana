...
<?php if(isset($result)):?>
    ...
    <?php echo form_open_multipart('dashboard/update_img/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
    ...
    <fieldset>
        ...
        <div class="col-lg-10 input-grup">
            ...
            <input type="text" id="title"  value="<?php echo $result['title']; ?>" name="title" class="form-control text-right" placeholder="   عنوان الصوره">
...
<?php else: ?>
    ...
    <?php echo form_open_multipart('dashboard/add_img',array('class'=>"form-horizontal",'role'=>"form" ))?>
    <fieldset>
...
<?php if(isset($records)&&$records!=null):?>
    ...
    <table id="no-more-tables" class="table table-bordered" role="table">
        ...
        <tr>
            ...
            <th class="text-right">حالة الصوره</th>
        ...
        <?php foreach($records as $record):?>
            ...
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a href="<?php echo base_url().'dashboard/update_img/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>

                    <a  href="<?php echo base_url().'dashboard/delete_img/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-5"><i class="fa fa-trash"></i> حذف</a>

                </td>

                <td data-title="حالة المقطع" class="text-center">

                    <a href="<?php echo base_url().'dashboard/suspend_img/'.$record->id.'/'.$class?>" class="btn btn-<?php echo $class ?> btn-xs col-lg-5"><?php echo $title ?> </a>
