...
class About extends CI_Controller
{
    ...
    ////////////////////end of excel library option
      ...
      /*  public function index(){
            $this->load->model('Us');
            $data['about']=$this->Us->select_web(1);
            $data['message']=$this->Us->select_web(2);
            $data['visions']=$this->Us->select_web(3);
            $this->load->model('Abouts');
            $data['goals']=$this->Abouts->select_web(1);
            $data['benifits']=$this->Abouts->select_web(3);
